...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a href="#" class="navbar-brand"> Mujtabaijaz</a>
    ...
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          ...
          <p class="text-center small"><a style="color: white; text-decoration: none; cursor: pointer;" href="mujtabaijaz" target="_blank"> This site is only used for Study purpose mujtabaijaz have all the rights. no one is allow to distribute copies other then <br>&trade; MujtabaIjaz &trade;  </a></p>
           </div>
         </div>
      </div>
    </footer>
